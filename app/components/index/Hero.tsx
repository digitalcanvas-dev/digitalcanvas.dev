...
export const Hero = ({}: HeroProps) => {
  ...
  return (
    <IndexSection className="grid h-screen grid-flow-row auto-rows-auto items-center justify-center gap-12 px-8 md:mx-auto md:max-w-screen-xl">
      <div className="flex flex-col gap-8 text-lg">
        ...
        <p className="font-body font-light text-brand">
          In the realm of art and design, traditional canvases have long been a
          staple for creators to express their imagination. However, with the
          advent of technology, a new medium has emerged — the digital canvas.
        </p>
        <span
